...
The public-comment record for **SLS-0005 Somali Capitalization Standard**. Required by
...
- **Standard:** SLS-0005 Somali Capitalization Standard
- **Status:** Proposed
- **Version:** 0.1.1
...
- **Comment venue:** [issue #13](https://github.com/goobolabs/somali-language-standard/issues/13)
- **Normative document:** [`spec/orthography/0003-capitalization.md`](../../spec/orthography/0003-capitalization.md)

The comment period is open. It cannot close before 2026-09-06. The supplementary-source limitation stated in the standard remains in force.
