...
| SLS-0003 | `Proposed` | Comment minimum; no `open` item; twelve priority questions and 36 of 42 per-rule verdicts complete; six rule verdicts remain for `Candidate` |
