...
| SLS-0003 | `Proposed` | Comment minimum; no `open` item; twelve priority questions and 32 of 42 per-rule verdicts complete; 10 rule verdicts remain for `Candidate` |
