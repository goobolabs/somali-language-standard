...
| SLS-0003 | `Proposed` | Comment minimum; no `open` item; twelve priority questions and 20 of 42 per-rule verdicts complete; 22 rule verdicts remain for `Candidate` |
