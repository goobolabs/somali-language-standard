...
| SLS-0003 | `Proposed` | Comment minimum; no `open` item; twelve priority questions and 24 of 42 per-rule verdicts complete; 18 rule verdicts remain for `Candidate` |
