...
| SLS-0003 | `Proposed` | Comment minimum; no `open` item; twelve priority questions and 28 of 42 per-rule verdicts complete; 14 rule verdicts remain for `Candidate` |
