...
- **SLS-0003 per-rule review: 32 of 42 verdicts complete, no version bump.**
  ...
  G14-R1 through G14-R6, plus G15-R1 through G15-R4 and G16-R1 through G16-R2,
  with their examples as written. The verdicts are recorded as MR-13 through
  MR-44. Maintainer audit M-4 also synchronized the packet's stale G13-R2
  summary with the reviewed normative examples; no normative requirement,
  example, or version changed.
